...
nbc_105_2020_dir = (base_dir / "Groups" / "NBC_105_2020")
if not nbc_105_2020_dir.exists():
    print('error getting nbc_105_2020_dir')
...
samples_data_file = nbc_105_2020_dir / "NBC_105_2020_samples.csv"
...
output_csv_file = nbc_105_2020_dir / "results.csv"
...
comp_samples_csv_file = nbc_105_2020_dir / "samples_completed.csv"
...
def run_analysis(u, CarlSagan):
    ...
    Analysis_output_dir = nbc_105_2020_dir / "Output" / f"sample_{sample_no}"
    ...
    Kfc = 1.44			    # ratio of confined to unconfined concrete strength
    ...
    def Section_Builder ():
        ...
        Beam_1_sec_name = 'Beam of Storey I, II Section'
        Beam_2_sec_name = 'Beam of Storey III, IV Section'

        nBT_Beam_1, nBM_Beam_1, nBIU_Beam_1, nBID_Beam_1, nBB_Beam_1 = 4, 0, 0, 0, 3          
        aBT_Beam_1, aBM_Beam_1, aBIU_Beam_1, aBID_Beam_1, aBB_Beam_1 = area(16.0), area(12.0), area(12.0), area(12.0), area(16.0)

        nBT_Beam_2, nBM_Beam_2, nBIU_Beam_2, nBID_Beam_2, nBB_Beam_2 = 3, 0, 0, 0, 2          
        ...
        # Column Type 1
        Col_1_sec_name = 'Col Type 1 Section : 4-20 + 4-16'
        nBT_Col_1 = 2       
        nBM_Col_1 = 2      
        nBIU_Col_1 = 1       
        nBID_Col_1 = 1       
        ...
        aBT_Col_1 = area(20.0)       
        aBM_Col_1 = area(16.0)        
        aBIU_Col_1 = area(16.0)        
        aBID_Col_1 = area(16.0)         
        aBB_Col_1 = area(20.0)         

        # Column Type 2
        Col_2_sec_name = 'Col Type 2 Section : 4-16 + 4-12'
        nBT_Col_2 = 2       
        nBM_Col_2 = 2       
        nBIU_Col_2 = 1       
        nBID_Col_2 = 1       
        ...
        aBT_Col_2 = area(16.0)       
        aBM_Col_2 = area(12.0)        
        aBIU_Col_2 = area(12.0)        
        aBID_Col_2 = area(12.0)         
        aBB_Col_2 = area(16.0)            
    ...
    if direction == 2:
        ...
        if NBayZ == 3:
            phiy[2], phiu[2], yieldM[2], ultM[2] = phiy[0], phiu[0], yieldM[0], ultM[0]
        if NBayZ == 4:
            phiy[2], phiu[2], yieldM[2], ultM[2] = phiy[0], phiu[0], yieldM[0], ultM[0]
            ...
            materials_function()
            Section_Builder()
            phiy[3], phiu[3], yieldM[3], ultM[3] = MomentCurvature3D(Col_2_SecTag, P, Col_2_z, Col_2_Cover, mu, numIncr, 'z', Fy_steel, E0_steel)

    else:
        print("ERROR Direction.")

    input_dir = (nbc_105_2020_dir / "Output" / f"sample_{sample_no}" / f"Earthquake_{CarlSagan}")
...
#     samples_completed_data_file = nbc_105_2020_dir / "samples_completed.csv"
#     samples_completed_data = np.genfromtxt(samples_completed_data_file, delimiter=',', skip_header=1)

#     all_tasks = [(u, CarlSagan) for u in range(31) for CarlSagan in range(len(GM_no_data))]
#     tasks = [(u, CarlSagan, samples_completed_data) for u, CarlSagan in all_tasks if not samples_completed_data[u, int(GM_no_data[CarlSagan])]]
