...
nbc_205_2012_dir = (base_dir / "Groups" / "NBC_205_2012")
if not nbc_205_2012_dir.exists():
    print('error getting nbc_205_2012_dir')
...
samples_data_file = nbc_205_2012_dir / "NBC_205_2012_samples.csv"
...
output_csv_file = nbc_205_2012_dir / "results.csv"
...
comp_samples_csv_file = nbc_205_2012_dir / "samples_completed.csv"
...
def run_analysis(u, CarlSagan):
    ...
    Analysis_output_dir = nbc_205_2012_dir / "Output" / f"sample_{sample_no}"
    ...
    Kfc = 1.25			    # ratio of confined to unconfined concrete strength
    ...
    def Section_Builder ():
        ...
        if bay_width_X <= 3000.0:
            ...
            nBT_Beam_1, nBM_Beam_1, nBIU_Beam_1, nBID_Beam_1, nBB_Beam_1  = 3, 0, 0, 0, 3           
            aBT_Beam_1, aBM_Beam_1, aBIU_Beam_1, aBID_Beam_1, aBB_Beam_1 = area(16.0), area(12.0), area(12.0), area(12.0), area(12.0) 

            nBT_Beam_2, nBM_Beam_2, nBIU_Beam_2, nBID_Beam_2, nBB_Beam_2  = 3, 0, 0, 0, 3           
            aBT_Beam_2, aBM_Beam_2, aBIU_Beam_2, aBID_Beam_2, aBB_Beam_2 = area(12.0), area(12.0), area(16.0), area(12.0), area(12.0) 

            nBT_Beam_3, nBM_Beam_3, nBIU_Beam_3, nBID_Beam_3, nBB_Beam_3  = 2, 0, 0, 0, 2           
            ...
            nBT_Beam_2, nBM_Beam_2, nBIU_Beam_2, nBID_Beam_2, nBB_Beam_2  = 2, 0, 1, 0, 3           
            aBT_Beam_2, aBM_Beam_2, aBIU_Beam_2, aBID_Beam_2, aBB_Beam_2 = area(12.0), area(12.0), area(16.0), area(16.0), area(12.0) 
            ...
            nBT_Beam_1, nBM_Beam_1, nBIU_Beam_1, nBID_Beam_1, nBB_Beam_1  = 3, 0, 0, 1, 2           
            aBT_Beam_1, aBM_Beam_1, aBIU_Beam_1, aBID_Beam_1, aBB_Beam_1 = area(16.0), area(12.0), area(12.0), area(12.0), area(16.0) 
            ...
            nBT_Beam_3, nBM_Beam_3, nBIU_Beam_3, nBID_Beam_3, nBB_Beam_3  = 3, 0, 0, 0, 2           
            aBT_Beam_3, aBM_Beam_3, aBIU_Beam_3, aBID_Beam_3, aBB_Beam_3 = area(12.0), area(10.0), area(10.0), area(10.0), area(12.0)
        ...
        if bay_width_Y <= 3000.0:
            ...
            nBT_Beam_4, nBM_Beam_4, nBIU_Beam_4, nBID_Beam_4, nBB_Beam_4  = 3, 0, 0, 0, 3           
            aBT_Beam_4, aBM_Beam_4, aBIU_Beam_4, aBID_Beam_4, aBB_Beam_4 = area(16.0), area(12.0), area(12.0), area(12.0), area(12.0) 

            nBT_Beam_5, nBM_Beam_5, nBIU_Beam_5, nBID_Beam_5, nBB_Beam_5  = 3, 0, 0, 0, 3           
            aBT_Beam_5, aBM_Beam_5, aBIU_Beam_5, aBID_Beam_5, aBB_Beam_5 = area(12.0), area(12.0), area(16.0), area(12.0), area(12.0) 

            nBT_Beam_6, nBM_Beam_6, nBIU_Beam_6, nBID_Beam_6, nBB_Beam_6  = 2, 0, 0, 0, 2           
            ...
            nBT_Beam_5, nBM_Beam_5, nBIU_Beam_5, nBID_Beam_5, nBB_Beam_5  = 2, 0, 1, 0, 3           
            aBT_Beam_5, aBM_Beam_5, aBIU_Beam_5, aBID_Beam_5, aBB_Beam_5 = area(12.0), area(12.0), area(16.0), area(16.0), area(12.0) 
            ...
            nBT_Beam_4, nBM_Beam_4, nBIU_Beam_4, nBID_Beam_4, nBB_Beam_4  = 3, 0, 0, 1, 2           
            aBT_Beam_4, aBM_Beam_4, aBIU_Beam_4, aBID_Beam_4, aBB_Beam_4 = area(16.0), area(12.0), area(12.0), area(12.0), area(16.0) 
            ...
            nBT_Beam_6, nBM_Beam_6, nBIU_Beam_6, nBID_Beam_6, nBB_Beam_6  = 3, 0, 0, 0, 2           
            aBT_Beam_6, aBM_Beam_6, aBIU_Beam_6, aBID_Beam_6, aBB_Beam_6 = area(12.0), area(10.0), area(10.0), area(10.0), area(12.0)
        ...
        # Column Type 1
        Col_1_sec_name = 'Col Type 1 Section : 4-16 + 4-12'
        ...
        nBIU_Col_1 = 1       # no. of longitudinal-reinforcement bars on mid layer || to local y axis
        nBID_Col_1 = 1       # no. of longitudinal-reinforcement bars on mid layer || to local y axis
        ...
        aBIU_Col_1 = area(12.0)         # area of mid layer bars || to local y axis
        aBID_Col_1 = area(12.0)         # area of mid layer bars || to local y axis
        aBB_Col_1 = area(16.0)         # area of bottom layer bars || to local z axis

        # Column Type 2
        Col_2_sec_name = 'Col Type 2 Section : 8-12'
        ...
        nBIU_Col_2 = 1       # no. of longitudinal-reinforcement bars on mid layer || to local y axis
        nBID_Col_2 = 1       # no. of longitudinal-reinforcement bars on mid layer || to local y axis
    ...
    for i in range(NplaneX):
        ...
        for j in range(NplaneY):
            ...
            endY = j + 1
            planeY = j + 1
            for k in range(NplaneZ - 1):     # 4-16 + 4-12, 8-12 : 1, 2
                startZ = k + 1
                endZ = startZ + 1
                planeZ = k + 1
    ...
    if direction == 2:
        ...
        materials_function()
        Section_Builder()
        phiy[0], phiu[0], yieldM[0], ultM[0] = MomentCurvature3D(Col_1_SecTag, P, Col_1_z, Col_1_Cover, mu, numIncr, 'z', Fy_steel, E0_steel)
        ...
        materials_function()
        Section_Builder()
        phiy[1], phiu[1], yieldM[1], ultM[1] = MomentCurvature3D(Col_2_SecTag, P, Col_2_z, Col_2_Cover, mu, numIncr, 'z', Fy_steel, E0_steel)

        if NBayZ == 3:
            phiy[2], phiu[2], yieldM[2], ultM[2] = phiy[1], phiu[1], yieldM[1], ultM[1]
...
#     tasks = [(u, CarlSagan) for u in range(31) for CarlSagan in range(len(GM_no_data))]
...
if __name__ == "__main__":
    samples_completed_data_file = nbc_205_2012_dir / "samples_completed.csv"
