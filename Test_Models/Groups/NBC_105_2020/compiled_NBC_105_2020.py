...
samples_data_file = '/Users/niraj/Documents/openseespy/Groups/NBC_105_2020/NBC_105_2020_samples.csv'
...
output_csv_file = '/Users/niraj/Documents/openseespy/Groups/NBC_105_2020/results.csv'
...
if u == 224:
    ...
    for CarlSagan in range(1,2):      # Loop through Earthquake No
        ...
        Analysis_output_dir = f'/Users/niraj/Documents/openseespy/Groups/NBC_105_2020/Output/sample_{sample_no}'
        ...
        if direction == 1:
            phiy, phiu, yieldM, ultM = MomentCurvature3D(Col_2_SecTag, P, Col_2_y, Col_2_Cover, mu, numIncr, 'y')
        elif direction == 2:
            phiy, phiu, yieldM, ultM = MomentCurvature3D(Col_2_SecTag, P, Col_2_z, Col_2_Cover, mu, numIncr, 'z')
        else:
            print("ERROR Direction.")
