...
# nBIU = int(nBIU) || 1 or 0 : longitudinal-reinforcement bar on upper mid layer || to y
# nBID = int(nBID) || 1 or 0 : longitudinal-reinforcement bar on down mid layer || to y
...
# aBIU = float(aBI) || area of upper mid layer bar || to y
# aBID = float(aBI) || area of down mid layer bars || to y
