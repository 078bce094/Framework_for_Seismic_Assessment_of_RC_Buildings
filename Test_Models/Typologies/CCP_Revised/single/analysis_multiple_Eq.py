...
for CarlSagan in range(1,2):
    ...
    if direction == 1:
        input_dir = f"/Users/niraj/Documents/openseespy/Groups/CCP_Revised/Output/sample_{sample_no}/Earthquake_{CarlSagan}/outputx"
    elif direction == 2:
        input_dir = f"/Users/niraj/Documents/openseespy/Groups/CCP_Revised/Output/sample_{sample_no}/Earthquake_{CarlSagan}/outputy"
