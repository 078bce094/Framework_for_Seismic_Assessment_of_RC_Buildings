...
def Section_Builder ():
    ...
    nBT_Beam_1 = 4       # no. of longitudinal-reinforcement bars on top layer || to local z axis
    ...
    nBT_Beam_2 = 4       # no. of longitudinal-reinforcement bars on top layer || to local z axis
    ...
    aBM_Beam_2 = area(16.0)         # area of mid layer bars || to local z axis
    aBI_Beam_2 = area(16.0)         # area of mid layer bars || to local y axis
    aBB_Beam_2 = area(16.0)         # area of bottom layer bars || to local z axis
    ...
    nBI_Col_2 = 2       # no. of longitudinal-reinforcement bars on mid layer || to local y axis
    nBB_Col_2 = 2       # no. of longitudinal-reinforcement bars on bottom layer || to local z axis
    aBT_Col_2 = area(16.0)         # area of top layer bars || to local z axis
    aBM_Col_2 = area(12.0)         # area of mid layer bars || to local z axis
    aBI_Col_2 = area(12.0)         # area of mid layer bars || to local y axis
    aBB_Col_2 = area(16.0)         # area of bottom layer bars || to local z axis
...
LL = 1.5e-3                                # Live load for all floors N per mm2
