...
for CarlSagan in range(1,2):
    ...
    if direction == 1:
        input_dir = f"/Users/niraj/Documents/openseespy/Typologies/Output/Earthquake_{CarlSagan}/outputx"
    elif direction == 2:
        input_dir = f"/Users/niraj/Documents/openseespy/Typologies/Output/Earthquake_{CarlSagan}/outputy"
    ...
    print(f"DI_Global for Earthquake {CarlSagan} = {i * 100:.2f} %")
